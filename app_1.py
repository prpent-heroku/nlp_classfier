...
def home_page_module():
    ...
    st.write("The objective of this project is to create a web application with Natural processing language tasks also can consume news headline sentences whichs provides a classification label to understand what the topic of the news article is and suggest an overall article sentiment.")
    ...
    with st.form(key='myform',clear_on_submit=True):
        ...
        if submit_button:
            if user_headline == '':
                ...
                tf1 = joblib.load(open("tfidf1.pkl", 'rb'))
