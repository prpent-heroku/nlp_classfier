...
def home_page_module():
    ...
    st.write("The objective of this project is to create a web application with Natural processing language tasks also can consume news headline sentences and provide a classification label to understand what the topic of the news article is and suggest an overall article sentiment.")
